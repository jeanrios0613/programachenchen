...
public partial class ToyoNoToyContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Useres>(entity =>
        {
            ...
            entity.Property(e => e.Gestion).HasMaxLength(4);
        });
        ...
        modelBuilder.Entity<VwUserRolesInfo>(entity =>
        {
            ...
            entity.Property(e => e.IndUpdate)
                  .HasColumnName("IndUpdate")        
                  .HasDefaultValue(false);
            entity.Property(e => e.UserCompania).HasMaxLength(256);
            entity.Property(e => e.Gestion).HasMaxLength(4);
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Gestores__06370DADC43399C8");
